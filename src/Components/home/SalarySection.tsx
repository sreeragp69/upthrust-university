...
const SalarySection = () => {
  ...
  return (
    <div className="bg-black relative  flex justify-center items-center py-20  overflow-hidden">
      ...
      <div className="relative  w-full  mx-auto">
        ...
        <div className=" w-1/2 mx-auto">
          <Title className="text-center text-white  leading-16!" title="Graphs of Salaries, Student Achievement, and other" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-20">
          ...
          <div className="relative max-h-[80%] w-full! backdrop-blur-xl rounded-4xl bg-linear-to-t from-[#363636]/30 to-[#D9D9D9]/20 border border-white/50 shadow-lg flex flex-col items-center justify-center  p-10">
            <div className="flex flex-col items-center gap-32 px-16">
              ...
              <div>
                <p className="text-white font-semibold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl leading-9 text-center">
                  <span className="bg-[#FABB1E] font-semibold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl leading-9 text-center rounded-lg p-0.5">
                    JOBS
                  </span>{" "}
          ...
          <GlassCard className="relative">
            <h3 className="text-xl font-semibold text-[#fe4000] mb-6">
              Salary Packages for Freshers in India
            </h3>
            <div className="flex flex-col gap-3">
              {salaryData.map((item, index) => (
                ...
                >
                  ...
                  <div className="text-[0.85rem] text-white/80">
                    {item.range}
                  </div>
                </div>
              ))}
          ...
          <div className="absolute   w-[800px] h-[800px]  xl:w-[1000px] xl:h-[1000px] 2xl:w-[1200px] 2xl:h-[1200px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-40 blur-[40px] animate-salary-float pointer-events-none z-[1] md:w-[600px] md:h-[600px]">
            <img
              src={ChartsImage}
              alt="Charts"
